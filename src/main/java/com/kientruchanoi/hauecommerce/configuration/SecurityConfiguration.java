...
import com.kientruchanoi.hauecommerce.configuration.jwt.JwtAuthenticationEntryPoint;
import com.kientruchanoi.hauecommerce.configuration.jwt.JwtAuthenticationFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/resource/**","/api/auth/sign-up", "/api/auth/login", "/api/auth/active-account",
                                "/api/account/password/forgot", "/api/account/password/renew", "/api/auth/validate").permitAll()
